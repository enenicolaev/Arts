...
/* harmony import */ var _modules_addStylesCards__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/addStylesCards */ "./src/js/modules/addStylesCards.js");
...
/* harmony import */ var _modules_slowScroll__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/slowScroll */ "./src/js/modules/slowScroll.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_0__["default"])(".button-consultation", ".popup-consultation", ".popup-consultation .popup-close");
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_0__["default"])(".fixed-gift", ".popup-gift", ".popup-gift .popup-close", true);
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])("form", "input");
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_3__["default"])("[name='phone']");
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])("[name='name']");
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])("[name='message']");
  Object(_modules_addStylesCards__WEBPACK_IMPORTED_MODULE_5__["default"])(".button-styles", "#styles .row");
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])("#size", "#material", '#options', '.promocode', '.calc-price');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_7__["default"])(".portfolio-menu", ".portfolio-wrapper");
  Object(_modules_showImg__WEBPACK_IMPORTED_MODULE_8__["default"])(".sizes-block");
  ...
  Object(_modules_slowScroll__WEBPACK_IMPORTED_MODULE_11__["default"])(".pageup");
...
/***/ "./src/js/modules/addStylesCards.js":
/*!******************************************!*\
  !*** ./src/js/modules/addStylesCards.js ***!
  \******************************************/
/*! exports provided: default */
...
function addStylesCards(trigger, wrapper) {
  ...
  btn.addEventListener("click", function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getCradInfo"])('assets/db.json').then(function (res) {
...
/* harmony default export */ __webpack_exports__["default"] = (addStylesCards);
    ...
    formsArray.forEach(function (item) {
      item.addEventListener("submit", function (e) {
        ...
        if (item.closest(".calc")) {
          var result = item.querySelector(".calc-price").textContent;
          formData.append("price", result);
        }

        ;
        var api; // динамический адрес
  ...
  upload.forEach(function (item) {
    item.addEventListener("input", function (e) {
      if (item.getAttribute("id") === "top-upload") {
        ...
        var formData = new FormData(item.parentElement);
        Object(_services_requests__WEBPACK_IMPORTED_MODULE_7__["postData"])(path.server, formData).then(function (res) {
          console.log(res);
        });
      }
...
function showModalByScroll(selector, condition) {
  var openModalOnce = true;
  window.addEventListener("scroll", function () {
    var scrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight); // для совместимости
...
function setIconByModal(selector, margin) {
  ...
  if (present) {
    present.style.marginRight = "".concat(margin, "px");
  }
}
...
function modal(triggerSelector, modalSelector, closeSelector) {
  ...
  var timerModal = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
...
/* harmony default export */ __webpack_exports__["default"] = (slowScroll);
...
/*!*************************************!*\
  !*** ./src/js/services/requests.js ***!
  \*************************************/
/*! exports provided: postData, getCradInfo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "postData", function() { return postData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCradInfo", function() { return getCradInfo; });
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat */ "./node_modules/core-js/modules/es.array.concat.js");
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__);
...
function getCradInfo(url) {
  var res;
  return regeneratorRuntime.async(function getCradInfo$(_context2) {
    while (1) {
